...
- **FLUX.1 [pro/dev/schnell] (Aug 2024)** becomes the de facto open-weight frontier at 12B rectified-flow parameters, with [schnell] shipping as an Apache-2.0 few-step distilled model. BFL's internal benchmarks claim FLUX.1 pro and dev surpass Midjourney v6.0, DALL·E 3 (HD), and SD3-Ultra on prompt following, typography, and output diversity; this is vendor-reported and should be read as directional, but has been corroborated qualitatively by independent reviewers throughout 2024–2025. [^9] > **Updated 2026-04-21:** These comparisons used Midjourney v6.0 and DALL·E 3 as the reference points at launch time (Aug 2024). The current competitive landscape is Midjourney v7 / v8 Alpha and **gpt-image-1 / gpt-image-1.5** (DALL·E 3 is being deprecated May 12, 2026). FLUX.1 Kontext [pro/max] (May 2025) and [dev] open weights (June 2025) extend BFL's line into editing.
...
- How do closed models (Midjourney v7/v8 Alpha, gpt-image-1/1.5, Imagen 4) compare? Without published training objectives, external benchmarks (GenEval, HRS-Bench, T2I-CompBench) are the only reliable signal. These mostly lag the research frontier by ~12 months and should not be treated as authoritative on prompt-adherence ceiling. > **Updated 2026-04-21:** DALL·E 3 is deprecated May 2026; **gpt-image-1 / gpt-image-1.5** is the correct OpenAI reference. Midjourney v7 shipped April 2025 (current default); v8 Alpha launched March 2026.
