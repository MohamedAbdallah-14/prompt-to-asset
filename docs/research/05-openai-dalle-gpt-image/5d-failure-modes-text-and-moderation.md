...
| 5 | Celebrity / public-figure refusal | High by name; moderate for well-known fictional characters | All OpenAI image models | Describe by features not name; accept that Disney/Pixar characters are off-limits after the 2025 $1B Disney–OpenAI licensing deal shifted rights to Sora | Named-entity detector runs on prompt text; plus a likeness classifier on output |
